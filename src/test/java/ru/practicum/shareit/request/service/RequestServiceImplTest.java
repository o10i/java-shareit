...
class RequestServiceImplTest {
    ...
    void save() {
        ...
        RequestDto savedRequestDto = service.save(request.getId(), requestShortDto);
    ...
    void findAllByRequestor() {
        ...
        List<RequestDto> requestDtos = service.findAllByRequestor(requestor.getId());
    ...
    void findAll() {
        ...
        List<RequestDto> requestDtos = service.findAll(requestor.getId(), 0, 20);
    ...
    void findById() {
        ...
        RequestDto savedRequestDto = service.findById(requestor.getId(), request.getId());
